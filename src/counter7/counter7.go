...
func (c *counter7) Start(hand1, hand2 string) int {
...
func (*counter7) isRoyalFlush(hand string) bool {
...
func (*counter7) getHandFaceCount(hand string) [15]int {
...
func (*counter7) getHandFaceCountTable(count [15]int) string {
...
func (*counter7) getHandFaceCountMap(count [15]int) map[int]string {
...
func (*counter7) getHandFaceCountTableByMap(countMap map[int]string) string {
	table := countMap[1] + countMap[2] + countMap[3] + countMap[4]
	return table
}

//getSevenHandFaceRank 得到牌型，如果有顺子、同花，会返回新的子串
func (c *counter7) getSevenHandFaceRank(hand string, faceCount [15]int) (int, string) {
	...
	if table == "4010" || table == "3200" || table == "5100" || table == "7000" {
		...
		if flush, maybe := c.maybeIsFlush(hand); maybe == true {
			//  如果是则判断是不是顺子
...
func (c *counter7) maybeIsFlush(hand string) (string, bool) {
...
func (c *counter7) isStraight(hand string) (string, bool) {
	hand = sort(hand)
	s := ""
...
//  判断无重复字符串是否是顺子
func (c *counter7) isStraightByNoDuplicate(hand string) (string, bool) {
	hand = sort(hand)
	straight := ""
...
func (c *counter7) isStraightByCount(count [15]int) (string, bool) {
	sb := strings.Builder{}
	for i := 14; i >= 2; i-- {
		v := count[i]
		if v == 0 {
...
func (c *counter7) equalJudgeStraight(hand1, hand2 string) int {
	var rst int
	var c1, c2 int
...
func (c *counter7) equalJudgePair(count1, count2 [15]int, rank int) int {
